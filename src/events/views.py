...
# https://www.reportlab.com/docs/reportlab-userguide.pdf for more info on reportlab
...
def delete_event(request, event_id):
    ...
    if request.user == event.manager:
        ...
        messages.success(request, "You Arent Authorised To Delete This Event!!")
        return redirect('list-events')
...
def my_events(request):
    if request.user.is_authenticated:
        ...
        messages.success(request, "You Arent Authorised To View This Page!!")
...
def list_venues(request):
    ...
    num = "A" * venues.paginator.num_pages
    return render(request, 'events/venue.html', {'venue_list': venue_list, 'venues':venues, 'num':num})
...
def venue_csv(request):
    ...
    venues = Venue.objects.all()
    writer.writerow(['Name', 'Address', 'Zip_Code', 'Phone', 'Web', 'Email_address'])
    for venue in venues:
...
def venue_events(request, venue_id):
    ...
    if events:
        ...
        messages.success(request, "That Venue Has No Events At This Moment")
...
def home(request, year=datetime.now().year, month=datetime.now().strftime('%B')):
    ...
    # query the event models for date
